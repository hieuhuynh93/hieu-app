        ...
        <div id="hs-application-sidebar" className="hs-overlay [--auto-close:lg]
            ...
            <nav className="flex flex-col size-full">
                ...
                <ul className="space-y-1.5 p-4">
                    <li>
                    <Link className="flex items-center px-3 py-2 text-sm text-gray-700 rounded-lg gap-x-3 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100" href="/chat/code">
                    ...
                    <li>
                    <a className="flex items-center px-3 py-2 text-sm text-gray-700 rounded-lg gap-x-3 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100" href="#">
                    ...
                    <li>
                    <a className="flex items-center px-3 py-2 text-sm text-gray-700 rounded-lg gap-x-3 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100" href="#">
                    <svg className="text-blue-600 shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
                        <span className="text-transparent bg-clip-text bg-linear-to-tl from-blue-600 to-violet-600">Upgrade Plan</span>
                    </a>
                    </li>
                </ul>
                {/* End List */}
                ...
                <div className="py-2.5 px-7">
                    <p className="inline-flex items-center text-xs text-green-600 gap-x-2">
                ...
                <div className="p-4 border-t border-gray-200">
                    <a className="flex items-center justify-between px-3 py-2 text-sm text-gray-700 rounded-lg gap-x-3 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100" href="#">
                    Sign in
